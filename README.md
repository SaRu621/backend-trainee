# backend-trainee: сервис динамического сегментирования пользователей
...
Также, если вдруг таблицы не существовали до работы приложения, то оно их создаст авооматически.
